...
import 'package:simple_chess_board/widgets/chess_vector.dart';

final whitePawnDefinition = <VectorDrawableElement>[
  VectorImagePathDefinition(
    path: "M 22,9 C 19.79,9 18,10.79 18,13 C 18,13.89 18.29,14.71 18.78,15.38"
...
final whiteKnightDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImagePathDefinition(
        path: "M 22,10 C 32.5,11 38.5,18 38,39"
            " L 15,39 C 15,30 25,32.5 23,18",
        drawingParameters: DrawingParameters(fillColor: Colors.white),
      ),
      VectorImagePathDefinition(
...
final whiteBishopDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImageGroup(
        children: <VectorDrawableElement>[
          VectorImagePathDefinition(
            path: "M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 "
          ...
          VectorImagePathDefinition(
            path: "M 15,32 C 17.5,34.5 27.5,34.5 30,32 C 30.5,30.5 30,30 30,30"
          ...
          VectorImagePathDefinition(
            path: "M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z",
            drawingParameters: DrawingParameters(),
          )
        ],
        drawingParameters: DrawingParameters(
...
final blackPawnDefinition = <VectorDrawableElement>[
  VectorImagePathDefinition(
    path: "M 22,9 C 19.79,9 18,10.79 18,13 C 18,13.89 18.29,14.71 18.78,15.38"
        " C 16.83,16.5 15.5,18.59 15.5,21 C 15.5,23.03 16.44,24.84 17.91,26.03"
        " C 14.91,27.09 10.5,31.58 10.5,39.5 L 33.5,39.5 C 33.5,31.58 29.09,"
...
final blackKnightDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImagePathDefinition(
      ...
      VectorImagePathDefinition(
        path: "M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,"
      ...
      VectorImagePathDefinition(
        path: "M 9.5 25.5 A 0.5 0.5 0 1 1 8.5,25.5 A 0.5 0.5 0 1 1 9.5 25.5 z",
        drawingParameters: DrawingParameters(
          fillColor: Colors.white,
      ...
      VectorImagePathDefinition(
        path: "M 15 15.5 A 0.5 1.5 0 1 1  14,15.5 A 0.5 1.5 0 1 1  15 15.5 z",
        drawingParameters: DrawingParameters(
          fillColor: Colors.white,
          strokeColor: Colors.white,
          transformMatrixValues: <double>[
      ...
      VectorImagePathDefinition(
        path: "M 24.55,10.4 L 24.1,11.85 L 24.6,12 C 27.75,13 30.25,14.49 "
...
final blackBishopDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImageGroup(
        children: <VectorDrawableElement>[
      ...
      VectorImagePathDefinition(
        path: "M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5"
            " M 20,18 L 25,18",
        drawingParameters: DrawingParameters(
            fillColor: null,
            strokeColor: Colors.white,
...
final blackRookDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImagePathDefinition(
        path: "M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z ",
...
final blackQueenDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImageGroup(
        children: <VectorDrawableElement>[
          VectorCircle(
            position: const Offset(6.0, 12.0),
            radius: 2.75,
            drawingParameters: DrawingParameters(),
          ),
          VectorCircle(
            position: const Offset(14.0, 9.0),
            radius: 2.75,
            drawingParameters: DrawingParameters(),
          ),
          VectorCircle(
            position: const Offset(22.5, 8.0),
            radius: 2.75,
            drawingParameters: DrawingParameters(),
          ),
          VectorCircle(
            position: const Offset(31.0, 9.0),
            radius: 2.75,
            drawingParameters: DrawingParameters(),
          ),
          VectorCircle(
            position: const Offset(39.0, 12.0),
            radius: 2.75,
            drawingParameters: DrawingParameters(),
          ),
        ],
...
final blackKingDefinition = <VectorDrawableElement>[
  VectorImageGroup(
    children: <VectorDrawableElement>[
      VectorImagePathDefinition(
        path: "M 22.5,11.63 L 22.5,6",
      ...
      VectorImagePathDefinition(
        path: "M 32,29.5 C 32,29.5 40.5,25.5 38.03,19.85 C 34.15,14 25,18 22.5,"
